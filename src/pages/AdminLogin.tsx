    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-muted p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <img src={logo} alt="Mzilikazi North Congregation" className="h-[320px] w-[320px] mx-auto mb-2 object-contain" />
          <CardTitle className="font-display text-2xl text-primary">Admin Portal</CardTitle>
          <p className="text-sm text-muted-foreground">Mzilikazi North Congregation Bulawayo</p>
        </CardHeader>
        <CardContent>
