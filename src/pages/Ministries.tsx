...
const Ministries = () => {
  ...
  const leagues = [
    {
      icon: Star, name: t.ministries_youth, desc: t.ministries_youth_desc,
    ...
    {
      icon: Users, name: t.ministries_men, desc: t.ministries_men_desc,
      meetingTime: "1st & 3rd Saturday at 8:00 AM", contact: "Elder J. Moyo",
      events: ["Men's Sports Day – April 5", "Leadership Workshop – April 19"],
    },
    {
      icon: Heart, name: t.ministries_women, desc: t.ministries_women_desc,
    ...
    {
      icon: BookOpen, name: t.ministries_sunday_school, desc: t.ministries_sunday_school_desc,
    ...
    <Layout>
      <section className="bg-gradient-purple py-20 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">{t.ministries_title}</h1>
              ...
              <Card key={l.name} className="shadow-soft border-border hover:shadow-medium transition-shadow">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="bg-primary/10 rounded-lg p-3"><l.icon className="h-6 w-6 text-primary" /></div>
