        ...
        <div className="relative z-20 h-full flex items-center justify-center">
          <div className="text-center px-4 max-w-3xl animate-fade-in">
            ...
            <h1 className="font-display text-3xl sm:text-5xl md:text-7xl font-extrabold text-white mb-3 sm:mb-4 leading-tight tracking-tight drop-shadow-[0_2px_6px_rgba(0,0,0,0.4)]">
              {t.home_hero_title_prefix} <span className="text-yellow-300 italic font-black uppercase tracking-widest drop-shadow-[0_2px_8px_rgba(255,215,0,0.5)]" style={{ fontFamily: "'Playfair Display', serif" }}>ELCZ - Mzilikazi</span> {t.home_hero_title_suffix}
            </h1>
