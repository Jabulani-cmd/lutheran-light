...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    home_hero_title_suffix: "North Congregation Bulawayo",
    ...
    home_pastor_quote: "\"Dear friends, whether you are a long‑standing member or visiting for the first time, know that you are welcome here. At Mzilikazi North Congregation, we believe in the power of community, the grace of God, and the call to serve one another. I invite you to join us as we walk together in faith, hope, and love.\"",
    ...
    about_subtitle: "Rooted in the Lutheran tradition since 1952, Mzilikazi North Congregation has been a beacon of faith, hope, and community.",
    about_history_title: "Our History",
    about_history_p1: "Mzilikazi North Congregation was founded in 1952 in the heart of Bulawayo, Zimbabwe. What began as a small group of faithful believers gathering under a tree has grown into a vibrant congregation serving hundreds of families across the community.",
    ...
    events_subtitle: "Stay connected with everything happening at Mzilikazi North Congregation.",
    events_all: "All",
  ...
  sn: {
    ...
    home_pastor_quote: "\"Shamwari dzangu, kana muri nhengo yenguva refu kana kushanyira kekutanga, zivai kuti muno gamuchirwa pano. KuMzilikazi North Congregation, tinotenda musimba reungano, nyasha dzaMwari, nekudana kwekushandira vamwe. Ndinokukokaii kuti tifambe tese mukutenda, tariro, nerudo.\"",
    home_pastor_name: "Rev. M. Ndlovu",
    ...
    about_subtitle: "Takadzika midzi mutsika yeLutheran kubva muna 1952, Mzilikazi North Congregation yakanga iri chiedza chekutenda, tariro, neungano.",
    about_history_title: "Nhoroondo Yedu",
    about_history_p1: "Mzilikazi North Congregation yakatangwa muna 1952 mumoyo meBulawayo, Zimbabwe. Zvakatangira seboka diki revanotenda vaiunganira pasi pemuti zvakakura kuva ungano ine simba inoshandira mazana emhuri muungano.",
    ...
    events_subtitle: "Garai makabatana nezvose zviri kuitika kuMzilikazi North Congregation.",
    events_all: "Zvose",
  ...
  nd: {
    ...
    home_pastor_quote: "\"Bangane bami, loba lingumlunga okade loba livakatshelwe okokuqala, yazini ukuthi lisamukelwa lapha. EMzilikazi North Congregation, sikholwa emandleni ebandla, emuseni kaNkulunkulu, lekubizweni kwethu ukusebenzela abanye. Ngiyalimema ukuthi sihambe ndawonye ekukholweni, ethembeni, lasothandweni.\"",
    home_pastor_name: "Rev. M. Ndlovu",
    ...
    about_subtitle: "Simi emasikweni eLutheran kusukela ngo-1952, iMzilikazi North Congregation ibilikukhanya lokholo, ithemba, lebandla.",
    about_history_title: "Imbali Yethu",
    about_history_p1: "IMzilikazi North Congregation yasungulwa ngo-1952 enhliziyweni yeBulawayo, eZimbabwe. Okwaqala njengeqembu elincane labakholwayo ababehlangana ngaphansi kwesihlahla sakhula saba libandla elilamandla elisebenzela amakhulu emindeni ebandleni.",
    ...
    events_subtitle: "Hlala uhlanganisiwe lakho konke okwenzakalayo eMzilikazi North Congregation.",
    events_all: "Konke",
  ...
  st: {
    ...
    home_pastor_quote: "\"Metswalle ya ka, le ka ba le setho sa nako e telele kapa le etela lekgetlo la pele, tsebang hore le amohelehile mona. Ho Mzilikazi North Congregation, re dumela matleng a seboka, mohauong wa Modimo, le pitsoang ya ho sebeletsa ba bang. Ke le mema hore re tsamaye mmoho tumelong, tshepolong, le leratong.\"",
    home_pastor_name: "Rev. M. Ndlovu",
    ...
    about_subtitle: "Re tsitsitse meetlong ya Lutheran ho tloha ka 1952, Mzilikazi North Congregation e bile lebone la tumelo, tshepo, le seboka.",
    about_history_title: "Histori ya Rona",
    about_history_p1: "Mzilikazi North Congregation e thehilwe ka 1952 pelong ya Bulawayo, Zimbabwe. Se qadileng e le sehlopha se senyenyane sa badumedi ba kopanang tlasa sefate se hodile ho ba seboka se matla se sebeletsang makgolo a malapa sebokeng.",
    ...
    events_subtitle: "Dula o hokahane le tsohle tse etsahalang ho Mzilikazi North Congregation.",
    events_all: "Tsohle",
  ...
  ve: {
    ...
    home_pastor_quote: "\"Khonani dzanga, arali ni muraḓo wa tshifhinga tshilapfu kana ni tshi dalela lwa u thoma, ḓivhani uri ni a ṱanganedzwa fhano. Kha Mzilikazi North Congregation, ri a tenda kha maanda a tshivhidzo, tshilidzi tsha Mudzimu, na u vhidziwa u shumela vhaṅwe. Ndi a ni ramba uri ri tshimbile roṱhe kha lutendo, fulufhelo, na lufuno.\"",
    home_pastor_name: "Rev. M. Ndlovu",
    ...
    about_subtitle: "Ro dzika midzi kha maitele a Lutheran u bva nga 1952, Mzilikazi North Congregation yo vha tshiedza tsha lutendo, fulufhelo, na tshivhidzo.",
    about_history_title: "Histori Yashu",
    about_history_p1: "Mzilikazi North Congregation yo thomiwa nga 1952 mbiluni ya Bulawayo, Zimbabwe. Zwo thomaho e tshigwada tshiṱuku tsha vhatendi vho vha vha tshi kuvhangana fhasi ha muri zwo aluwa zwa vha tshivhidzo tshi re na maanda tshi shumelaho maḓana a miṱa tshivhidzoni.",
    ...
    events_subtitle: "Dzulani no ṱanganiswa na zwoṱhe zwi itaho kha Mzilikazi North Congregation.",
    events_all: "Zwoṱhe",
